...
ObsSquad_Prepare_Environment() {
    ...
    sed -i "s/^OVERRIDE_PROXYVER=.*$/OVERRIDE_PROXYVER=tags/v1.1.57/" "$config_file"
...
ObsSquad_Copy_Configuration() {
    ...
    local config_source_dir="$HOME/mvx-api-deployer/config/$NETWORK/0-observingSquad/elrond-nodes"
