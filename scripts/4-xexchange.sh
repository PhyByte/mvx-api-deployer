...
xExchange_Copy_Configuration() {
    ...
    local source_dir="$HOME/mvx-api-deployer/configurationFiles/services/2-mx-exchange-service"
    local repo_dir="$HOME/mx-exchange-service"
...
xExchange_Create_Service() {
    ...
    sudo cp "$HOME/mvx-api-deployer/configurationFiles/services/2-mx-exchange-service/mvx-exchange.service" "$service_file" || {
