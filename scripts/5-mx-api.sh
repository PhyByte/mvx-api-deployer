...
MxApi_Copy_Configuration() {
    ...
    local source_dir="$HOME/mvx-api-deployer/config/$NETWORK/3-mx-api-service"
    local repo_dir="$HOME/mx-api-service"
...
MxApi_Create_Service() {
    ...
    sudo cp "$HOME/mvx-api-deployer/config/$NETWORK/3-mx-api-service/mvx-api.service" "$service_file" || {
